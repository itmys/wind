...
function sendmail_legacy($to, $subject, $body, $from_name='', $from_email='', $cc_to_sender=FALSE) {
	global $vars, $lang;
...
function sendmail($to, $subject, $body, $from_name='', $from_email='', $cc_to_sender=FALSE) {
	 global $vars;
	 $smtp_server = $vars['mail']['smtp'];
	 if ($smtp_server == '') {
		return sendmail_legacy($to, $subject, $body, $from_name, $from_email, $cc_to_sender);
	 } else {
		return sendmail_phpmailer($to, $subject, $body, $from_name, $from_email, $cc_to_sender);
	 }
}
